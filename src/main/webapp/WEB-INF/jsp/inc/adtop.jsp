...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/adtop.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/sign.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/login.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/recoupon.css">
...
<div class="bodyWrapper">
    <div class="topWrapper">
        <div class="firstTopDiv">
            <div class="adCouponDiv">
                <p id="adName">쿠폰등록하기</p>
            </div>
        </div>
        <div class="secondTopDiv">
            ...
            <div class="adcouponInfoDiv">
                <p style="color: #00a5d6; margin-left: -8%;">스타벅스 장성점</p>
            </div>
        </div>
    </div><!--topWrapper-->
